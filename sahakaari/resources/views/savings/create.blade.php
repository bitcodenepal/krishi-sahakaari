...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="tile">
                <form class="form-horizontal" method="post" action="{{ route('savings.store') }}">
                    @csrf
                    <div class="tile-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select name="acc_type" id="acc-type"
                                    ...
                                    <option value="नियमित" {{ (old('acc_type') == "नियमित" ? 'selected' : '') }}>
                                        नियमित
                                    </option>
                                    <option value="खुत्रुके" {{ (old('acc_type') == "खुत्रुके" ? 'selected' : '') }}>
                                        खुत्रुके
                                    </option>
                                    <option value="ऐच्छिक" {{ (old('acc_type') == "ऐच्छिक" ? 'selected' : '') }}>
                                        ऐच्छिक
                                    </option>
                                </select>
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="acc_no"
                                           ...
                                           placeholder="खातावालाको खाता नम्बर" value="{{ old('acc_no') }}">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="money"
                                           ...
                                           placeholder="खातावालाले दिएका कुल रकम" value="{{ old('money') }}">
                                    @if($errors->has('money'))
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="interest"
                                           ...
                                           placeholder="कुल ब्याजदर" value="{{ old('interest') }}">
