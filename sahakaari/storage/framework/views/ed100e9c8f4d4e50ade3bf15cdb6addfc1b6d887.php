<?php $__env->startSection('content'); ?>
  ...
  <div class="app-title">
    <h1><a href="<?php echo e(route('savings.index')); ?>"><i class="fa fa-arrow-circle-left fa-fw"></i></a>
        &nbsp;&nbsp;&nbsp; <?php echo e($loan->share->name); ?>को विवरण (खाताको प्रकार => <?php echo e($loan->loan_type); ?>)
    </h1>
  </div>
    ...
    <div class="col-md-12">
        <div class="tile">
          ...
          <table class="table table-sm table-bordered table-hover">
            ...
            <tbody>
              <?php $__currentLoopData = $loan_balances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $balance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    ...
                    <td><?php echo e(($balance->loan_duration != 0 ) ? $balance->loan_duration. " days" : $loan_duration. " days"); ?></td>
                    <td>Rs. <?php echo e(($balance->payment == null) ? 0 : $balance->deposit); ?></td>
                    <td>Rs. <?php echo e($balance->amount); ?></td>
                    <td><?php echo e($balance->interest); ?> %</td>
                    <td><?php echo e(($balance->extra_interest == null) ? "0 %" :  $balance->extra_interest); ?></td>
                    <td>Rs. <?php echo e(($balance->interest_amount != 0) ? $balance->interest_amount : $interest_amount); ?></td>
                    <td>Rs. <?php echo e(($balance->loan_amount != 0) ? $balance->loan_amount : $loan_amount); ?></td>
...
<div class="modal" id="change-balance">
  <div class="modal-dialog" role="document">
    <div class="modal-content" style="border-radius: 0px;">
      ...
      <form action="<?php echo e(route('loan.balance', $loan->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="loan_duration" value="<?php echo e($loan_duration); ?>">
        <input type="hidden" name="interest_amount" value="<?php echo e($interest_amount); ?>">
        <input type="hidden" name="saving_amount" value="<?php echo e($loan_amount); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sahakaari\sahakaari\resources\views/loan/show.blade.php ENDPATH**/ ?>