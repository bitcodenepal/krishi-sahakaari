                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="creation_date" id="nepaliDate10"
                                        class="form-control <?php echo e(($errors->has('creation_date')) ? 'is-invalid' : ''); ?>" placeholder="ऋणको मिति (YYYY-MM-DD)" value="<?php echo e(old('creation_date')); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sahakaari\sahakaari\resources\views/loan/create.blade.php ENDPATH**/ ?>