...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="tile">
                <form class="form-horizontal" method="post" action="<?php echo e(route('savings.update', $saving->id)); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select name="acc_type" id="acc-type"
                                    ...
                                    <option value="नियमित" <?php echo e(($saving->acc_type == "नियमित") ? 'selected' : ''); ?>>
                                        नियमित
                                    </option>
                                    <option value="खुत्रुके" <?php echo e(($saving->acc_type == "खुत्रुके") ? 'selected' : ''); ?>>
                                        खुत्रुके
                                    </option>
                                    <option value="ऐच्छिक" <?php echo e(($saving->acc_type == "ऐच्छिक") ? 'selected' : ''); ?>>
                                        ऐच्छिक
                                    </option>
                                </select>
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="acc_no"
                                           ...
                                           placeholder="खातावालाको खाता नम्बर" value="<?php echo e($saving->acc_no); ?>">
                            ...
                            <div class="col-md-8">
                                <select name="share_id" id="share-id" class="form-control select2">
                                    ...
                                    <?php $__currentLoopData = $nos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $no): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($no); ?>" <?php echo e(($saving->share->no == $no) ? "selected" : ""); ?>><?php echo e($no); ?></option>
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="money"
                                           ...
                                           placeholder="खातावालाले दिएका कुल रकम" value="<?php echo e(old('money', $saving->money)); ?>">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="interest"
                                           ...
                                           placeholder="कुल ब्याजदर" value="<?php echo e($saving->interest); ?>">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="creation_date" id="nepaliDate10"
                                        class="form-control <?php echo e(($errors->has('creation_date')) ? 'is-invalid' : ''); ?>" value="<?php echo e($saving->creation_date); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sahakaari\sahakaari\resources\views/savings/edit.blade.php ENDPATH**/ ?>